...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/neverhaveiever',
        'Source': 'https://github.com/apiverve/neverhaveiever-api',
        'Bug Tracker': 'https://github.com/apiverve/neverhaveiever-api/issues'
    },
    classifiers=[
