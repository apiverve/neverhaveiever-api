...
```gradle
dependencies {
    implementation 'com.github.apiverve:neverhaveiever-api:1.1.14'
}
```
...
```java
import com.apiverve.neverhaveiever.NeverHaveIEverAPIClient;
import com.apiverve.neverhaveiever.APIResponse;
import com.apiverve.neverhaveiever.APIException;

// Initialize the client
NeverHaveIEverAPIClient client = new NeverHaveIEverAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/neverhaveiever](https://docs.apiverve.com/ref/neverhaveiever)
...
- **Documentation:** [https://docs.apiverve.com/ref/neverhaveiever](https://docs.apiverve.com/ref/neverhaveiever)
- **Issues:** [GitHub Issues](https://github.com/apiverve/neverhaveiever-api/issues)
