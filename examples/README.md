# Never Have I Ever API - Examples

This folder contains example code for using the Never Have I Ever API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/neverhaveiever',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/neverhaveiever");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/neverhaveiever](https://docs.apiverve.com/ref/neverhaveiever)
