// Package neverhaveiever provides a Go client for the Never Have I Ever API.
//
// For more information, visit: https://apiverve.com/marketplace/neverhaveiever?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/neverhaveiever"
	defaultTimeout = 30 * time.Second
)

// Client is the Never Have I Ever API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Never Have I Ever API client.
...
// Execute makes a request to the Never Have I Ever API with typed parameters.
//
...
//   - adult: boolean - Include adult/relationship-focused statements
