...
namespace APIVerve.API.NeverHaveIEver
{
    ...
    /// <summary>
    /// Client for the NeverHaveIEver API
    /// </summary>
    public class NeverHaveIEverAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/neverhaveiever";
        ...
        public NeverHaveIEverAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NeverHaveIEverAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public NeverHaveIEverAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, NeverHaveIEverQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(NeverHaveIEverQueryOptions options)
        {
        ...
        public ResponseObj Execute(NeverHaveIEverQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(NeverHaveIEverQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(NeverHaveIEverQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(NeverHaveIEverQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(NeverHaveIEverQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(NeverHaveIEverQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(NeverHaveIEverQueryOptions options)
        {
